...
int main(){
    ...
    Shader nanosuitShader("./nanosuit.vs", "./nanosuit.fs");
    Shader reflectShader("./reflectShader.vs", "./reflectShader.fs");
    ...
    const Model nanosuitModel("./nanosuit.obj"); // 纹理单元(0, 1)表示diff和reflect
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        glActiveTexture(GL_TEXTURE2);
        glBindTexture(GL_TEXTURE_CUBE_MAP, skyboxTexture);
        nanosuitModel.draw(reflectShader);
        ...
        glActiveTexture(GL_TEXTURE2);
        glBindTexture(GL_TEXTURE_CUBE_MAP, skyboxTexture);
        nanosuitModel.draw(refractShader);
